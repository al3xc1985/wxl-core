// WDL translator: rebuild a modern WDL into the 335 MAOF/MARE/MAHO shape.
...
// HOST-only. WDL translator: rebuild a modern WDL into the 335 MAOF/MARE/MAHO shape. Pure bytes -> 335 bytes. Free functions, span-based, concrete.
...
{
    // Rebuild a modern low-detail WDL into the 335 MAOF/MARE/MAHO shape.
